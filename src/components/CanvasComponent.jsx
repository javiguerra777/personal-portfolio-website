...
const CanvasComponent = () => {
  ...
  context.fillRect(player.x, player.y, player.height, player.width);
    ...
    context.fillRect(10, 10, 350, 200);
    context.strokeStyle = "white";
    context.strokeText("Hello World",150,40);
  ...
  //       if ( player.y > npc.y+ npc.height&& player.direction === "right") {
  //         console.log('collision right');
  //         dispatch((changeX(-npc.width)))
  //       }
  ...
  //  useEffect(() => {
  //   dispatch(changeDirection(player.direction))
  // }, [player.direction, dispatch]);
  return (
