    ...
    >
      ...
      <JobContentContainer>
        ...
        <JobDescription>
          ...
          Typescript, Eslinter, Prettier, Redux, and Async Thunks into
          a React web application. I learned how to use Fetch and
          Axios to send HTTP request to API servers. I acquired
          knowledge of Git, Github, Branching and Git Flow. I also am
          obtaining Angular, Wordpress, and .Net experience because I
          have had to build projects with those technologies. I built
          a multiplayer video game using React, Phaser, Redux,
          Express, Socket.io and MongoDB. I am creating a social media
          web application using React, Redux, Express, AWS, Socket.io
          and MongoDB.
        </JobDescription>
        <FlexBetween>
