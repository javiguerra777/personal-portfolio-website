    ...
    <AboutWrapper id="about">
      <div className='pt-20 pb-5 px-4 flex flex-col md:flex-row'>
        ...
        <div className="w-full md:w-90 p-1">
          ...
          <p className="mb-4">I graduated from Stanislaus State in 2022 where I obtained my MBA in Finance. I graduated from the University of the Pacific, where I obtained my Bachelor's Dergree in Business Administration.</p>
