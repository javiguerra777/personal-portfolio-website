  ...
  return (
    <AboutWrapper id="about">
      <div className='pt-20 pb-5 px-4 flex flex-col md:flex-row'>
        <img className="bg-red-100 w-full h-96" src={Logo} />
        <div className="w-full md:w-90 p-1">
          ...
          <div className="flex flex-row mt-7">
            <a href="https://www.linkedin.com/in/javiermguerra01/" target='_blank'>
              <AiFillGithub size={30} />
            </a>
            <a href="https://github.com/javiguerra777" target="_blank" className="ml-5">
